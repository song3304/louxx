<div class="form-group">
	...
	<div class="col-md-9">
		<select id="id" name="id" class="select-model form-control" data-model="admin/member" data-text="{{username}}" data-term="{{username}}" data-placeholder="请输入该物业用户." value="<{$_data.id}>"></select>
	</div>
</div>
<div class="form-group">
