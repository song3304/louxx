<div class="tab-content">
	<div class="tab-pane active" id="form-1">
		...
		<div class="form-group">
			...
			<div class="col-md-9">
					<select type="text" id="tag_ids" name="tag_ids[]" class="form-control select-model" data-params='{"f[type]":"0"}' data-model="admin/tag" data-text="{{tag_name}}" data-term="{{tag_name}}" data-placeholder="请输入标签..." value="<{if !empty($_data->tag_ids)}><{$_data->tag_ids|implode:','}><{/if}>" multiple="multiple"></select>
			</div>
		</div>
