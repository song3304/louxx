...
<form action="<{'admin'|url nofilter}>/<{block "name"}><{/block}>" method="GET" class="form-bordered form-horizontal">
	<div class="form-group col-sm-4">
		...
		<div class="col-md-9">
			<input type="text" id="title" name="f[title][like]" class="form-control" placeholder="请输入标题..." value="<{$_filters.title.like}>">
		</div>
	</div>
	<div class="form-group col-sm-4">
		<label class="col-md-3 control-label" for="contents">内容关键字</label>
		<div class="col-md-9">
			<input type="text" id="contents" name="f[contents][like]" class="form-control" placeholder="请输入内容关键字..." value="<{$_filters.contents.like}>">
		</div>
	</div>
	<div class="form-group col-sm-4">
