			...
			<ul class="sidebar-nav">
				...
				<li>
					...
					<ul>
						...
						<li><a href="<{'admin/wechat/depot'|url}>" name="wechat/article/list" class="col-md-8">素材管理</a><a href="<{'admin/wechat/article/create'|url}>" name="wechat/article/create" class="col-md-4"><i class="glyphicon glyphicon-plus"></i> 添加</a><div class="clearfix"></div></li>
