...
<form action="<{'property'|url nofilter}>/<{block "name"}><{/block}>" method="GET" class="form-bordered form-horizontal">
	...
	<div class="form-group col-sm-4">
		<label class="col-md-3 control-label" for="rent">租金(元/月)</label>
		<div class="col-md-9">
			<div class="input-group">
				<input type="text" id="rent" name="f[rent][eq]" class="form-control" placeholder="请输入月租金..." value="<{$_filters.rent.eq}>">
	...
	<div class="form-group col-sm-4">
		...
		<div class="col-md-9">
			<select type="text" id="oid" name="f[oid][in][]" class="form-control select-model" data-model="property/building" data-text="{{village_name}}-{{building_name}}" data-placeholder="请输入楼名..." value="<{if !empty($_filters.oid)}><{$_filters.oid.in|implode:','}><{/if}>"></select>
		</div>
	</div>
	<div class="form-group col-sm-4">
