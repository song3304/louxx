...
<head>
	...
	<{include file="property/common/styles.inc.tpl"}>
	<{include file="property/common/scripts.inc.tpl"}>
	<script src="<{'js/chart/flot/jquery.flot.min.js'|static}>"></script>
</head>

<body class="page-loading">
	<{include file="property/common/loading.inc.tpl"}>
	<div id="page-container" class="sidebar-partial sidebar-visible-lg sidebar-no-animations">
		<{include file="property/sidebar.inc.tpl"}>

		<!-- Main Container -->
		<div id="main-container">
			<{include file="property/menubar.inc.tpl"}>
					...
					<div class="header-section">
						<div class="row">
							...
							<div class="col-md-4 col-lg-6 hidden-xs hidden-sm">
								<h1>欢迎 <strong><{$_user.nickname}></strong> <{if $_user.gender.name=='male'}>先生<{else if $_user.gender.name=='female'}>女士<{/if}><br><small>欢迎登录楼查查物业管理系统！</small></h1>
							</div>
							<!-- END Main Title -->
								...
								<div class="row text-center">
									<div class="col-xs-4 col-sm-3">
										<h2 class="animation-hatch">
											<strong>5</strong>幢<br>
											<small><i class="fa fa-thumbs-o-up"></i> 办公楼</small>
										</h2>
									</div>
									<div class="col-xs-4 col-sm-3">
										<h2 class="animation-hatch">
											<strong>188</strong>家<br>
											<small><i class="fa fa-heart-o"></i>公司</small>
										</h2>
									</div>
									<div class="col-xs-4 col-sm-3">
										<h2 class="animation-hatch">
											<strong>18</strong>条<br>
											<small><i class="fa fa-calendar-o"></i> 招租</small>
										</h2>
									</div>
									<!-- We hide the last stat to fit the other 3 on small devices -->
									<!-- div class="col-sm-3 hidden-xs">
										<h2 class="animation-hatch">
											<strong>55</strong>个<br>
											<small><i class="fa fa-map-marker"></i> 广告位</small>
										</h2>
									</div-->
								</div>
							</div>
			...
			<{include file="property/copyright.inc.tpl"}>
		</div>
		<!-- END Main Container -->
	</div>
	<!-- END Page Container -->
