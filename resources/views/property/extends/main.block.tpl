...
<{block "head"}>
	...
	<{include file="property/common/ui.inc.tpl"}>
...
<div id="page-wrapper">
	<{block "loading"}><{include file="property/common/loading.inc.tpl"}><{/block}>
	<div id="page-container" class="sidebar-partial sidebar-visible-lg sidebar-no-animations">
		<{block "siderbar"}><{include file="property/sidebar.inc.tpl"}><{/block}>
		<!-- Main Container -->
		<div id="main-container">
			<{block "menubar"}><{include file="property/menubar.inc.tpl"}><{/block}>
			 <!-- Page content -->
			<div id="page-content">
			<{block "header"}>
				<{block "banner"}>
			...
			<{block "copyright"}><{include file="property/copyright.inc.tpl"}><{/block}>
		</div>
		<!-- END Main Container -->
	</div>
	<!-- END Page Container -->
