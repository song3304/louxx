...
class PeripheryController extends Controller
{
	...
	public function index(Request $request)
	{
		...
		return $this->view('property.periphery.list');
	}
	...
	public function show(Request $request,$id)
	{
		...
		return !$request->offsetExists('of') ? $this->view('property.periphery.show') : $this->api($office_periphery->toArray());
	}
	...
	public function create()
	{
		...
		return $this->view('property.periphery.create');
	}
	...
	public function store(Request $request)
	{
		...
		return $this->success('', url('property/periphery'));
	}
	...
	public function edit($id)
	{
		...
		$this->_validates = $this->getScriptValidate('periphery.store', $keys);
		$this->_data = $office_periphery;
		return $this->view('property.periphery.edit');
	}
	...
	public function update(Request $request, $id)
	{
		...
		return $this->success('', url('property/periphery/'.$id.'/edit'));
	}
